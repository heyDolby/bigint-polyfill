(function () {
	...
	const nativeBigInt = (typeof commonjsGlobal !== 'undefined') && commonjsGlobal.BigInt || (typeof window !== 'undefined') && window.BigInt;
	const supportsNative = typeof nativeBigInt === 'function';
	const _BigInt = BigInteger.exports;

	const nativeFunction = function (operator, a) {
	    switch (operator) {
	      // Arithmetic operators
	      case 'add': return (b) => new BigInt$1(a + b);
	      case 'subtract': return (b) => new BigInt$1(a - b);
	      case 'multiply': return (b) => new BigInt$1(a * b);
	      case 'divide': return (b) => new BigInt$1(a / b);
	      case 'remainder': return (b) => new BigInt$1(a % b);
	      case 'pow': return (b) => new BigInt$1(a ** b);
	      // Bitwise shift operators
	      case 'shiftLeft': return (b) => new BigInt$1(a << b);
	      case 'shiftRight': return (b) => new BigInt$1(a >> b);
	      // Binary bitwise operators
	      case 'and': return (b) => new BigInt$1(a & b);
	      case 'or': return (b) => new BigInt$1(a | b);
	      case 'xor': return (b) => new BigInt$1(a ^ b);
	      ...
	      // Unary operators
	      case 'negate': return () => new BigInt$1(- a);
	      case 'not': return () => new BigInt$1(~ a);
	      case 'next': return () => new BigInt$1(++a);
	      case 'prev': return () => new BigInt$1(--a);
	    }
	    return undefined;
	};
	...
	class BigInt$1 {
	    constructor(value) {
	        if (typeof value === 'bigint') {
	            this.value = value;
	        } else if (value instanceof BigInt$1) {
	            return value; 
	        } else {
	    ...
	    static fromUint8Array(uint8arr, littleEndian = false, detectSupport = true) {
	        if (supportsNative && detectSupport) {
	            ...
	            return new BigInt$1(view.getBigUint64(0, littleEndian));
	        }
	        let array;
	        if (littleEndian) {
	        ...
	        return new BigInt$1(_BigInt.fromArray(array, 2**8));
	    }
	}

	var bigintPolyfill = BigInt$1;

	const BigInt = bigintPolyfill;
